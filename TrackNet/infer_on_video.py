...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', type=str, default='model_best.pt', help='path to model')
    parser.add_argument('--video_path', type=str, default='uploads/received_video.mp4', help='path to input video')
    parser.add_argument('--video_out_path', type=str, default = 'uploads/output.mp4', help='path to output video')
