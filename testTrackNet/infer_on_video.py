...
if __name__ == '__main__':
    ...
    parser.add_argument('--video_path', type=str, default='tennis_match.mp4', help='path to input video')
    parser.add_argument('--video_out_path', type=str, default = 'tennis_match_output.mp4', help='path to output video')
